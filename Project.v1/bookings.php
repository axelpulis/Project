...
<html lang="en">
  ...
  <body>
   <body>
    <?php
    $conn = mysqli_connect("localhost","root","","axeldb",3307);
...
<br><br><br><br>
  ...
  <div class="form-row">
   ...
   <div class="form-row">
    <div class="form-group col-md-6">
      <select required class="form-control" id="exampleFormControlSelect1" name="barber" >
    ...
    <div class="form-group col-md-6">
      <select required class="form-control" id="exampleFormControlSelect1" name="service" >
