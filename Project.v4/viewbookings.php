...
<br><br><br><br>
    ...
    <div class="container">
     ...
     <h1 class="display-4">My Appointments</h1><br>   
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Cancel</th>
        ...
        $get_future_bookings = "SELECT * FROM booking WHERE start_date > '$currentDateTime' AND client_id = $client_id";
        
        $result = mysqli_query($conn, $get_future_bookings);
               
        //if ($result)
        //{
        //$array = mysqli_fetch_assoc($result);
    //    $service_id = $array['service_id'];
      //  $dateTime = $array['start_date'];
    //    $barber_id = $array['barber_id'];
      //  }
        //echo $dateTime;
       ...
       while ($row = mysqli_fetch_assoc($result)){
            echo "$row[start_date] $row[service_id] $row[barber_id]  <br/>";
        }
