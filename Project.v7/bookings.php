...
<html lang="en">
    <head>
        ...
        <title>ShaveCave - Make Appointment</title>
    </head>
...
<br><br><br><br>
    ...
    <div class="container">
     ...
     <h1 class="display-4">Make Appointment</h1><br>   
  ...
  <button type="submit" class="btn btn-primary  btn-block" name="submit">Check Availability</button>
</form>
...
<?php
         ...
         ?>
                    <hr class="my-4">
                      <h1 class="display-4">Confirm Appointment</h1><br> 
...
<div class="card card-image mb-3" style="background-image: url('images/card.jpg');">
    ...
    <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4">
        <div>
            <h3 class="card-title pt-2"><strong>ShaveCave Appointment</strong></h3>
           <?php
